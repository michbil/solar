...
/*  20:    */ 
/*  21:    */ public class SystemConsoleTray
/*  22:    */   extends SolarPowerTray
/*  23:    */ {
/*  24:    */   private static final long serialVersionUID = -8595494141273185107L;
...
/*  64: 58 */         initMenu();
/*  65: 59 */         String softwareName = GlobalVariables.customerConfig.getCustomerName();
/*  66: 60 */         trayIcon = new TrayIcon(Constants.CONNECTEDIMG, softwareName, 
/*  67: 61 */           popup);
/*  68: 62 */         addToSystemTray();
/*  69:    */       }
/*  70:    */       catch (Exception e)
/*  71:    */       {
/*  72: 64 */         e.printStackTrace();
/*  73:    */       }
/*  74:    */     }
/*  75:    */   }
/*  76:    */   
/*  77:    */   public void addToSystemTray()
/*  78:    */   {
/*  79:    */     try
/*  80:    */     {
/*  81: 74 */       this.tray.remove(trayIcon);
/*  82: 75 */       this.tray.add(trayIcon);
/*  83:    */     }
...
/*  88:    */   }
/*  89:    */   
/*  90:    */   public void initMenu()
/*  91:    */     throws Exception
/*  92:    */   {
/*  93: 82 */     this.configItem = new MenuItem("Configuration");
/*  94: 83 */     this.updateItem = new Menu("Software Upgrade");
/*  95: 84 */     this.updateOnline = new MenuItem("Online Upgrade");
/*  96: 85 */     this.updateByUser = new MenuItem("Manually Upgrade");
/*  97: 86 */     this.updateItem.add(this.updateOnline);
/*  98: 87 */     this.updateItem.add(this.updateByUser);
/*  99: 88 */     this.openItem = new MenuItem("Open Monitor");
/* 100: 89 */     this.exitItem = new MenuItem("Exit");
/* 101: 90 */     popup.add(this.configItem);
/* 102: 91 */     popup.add(this.updateItem);
/* 103: 92 */     popup.add("-");
/* 104: 93 */     popup.add(this.openItem);
/* 105: 94 */     popup.add("-");
/* 106: 95 */     popup.add(this.exitItem);
/* 107:    */     
/* 108:    */ 
...
/* Location:           F:\tmp\wp\
 * Qualified Name:     cn.com.voltronic.solar.console.windows.SystemConsoleTray
